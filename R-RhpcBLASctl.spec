...
pushd ..
cp -a RhpcBLASctl buildavx2
popd
pushd ..
cp -a RhpcBLASctl buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1714076063
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/RhpcBLASctl/libs/RhpcBLASctl.so
/V4/usr/lib64/R/library/RhpcBLASctl/libs/RhpcBLASctl.so
